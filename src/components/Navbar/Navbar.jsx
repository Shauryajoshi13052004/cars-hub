...
<Router>
    <nav ax-data="{ isOpen: false }" className="relative bg-white shadow dark:bg-gray-800">
    <div className="container px-6 py-3 mx-auto md:flex">
        <div className="flex items-center justify-between">
            <Link to="/home">
                <img className="w-auto h-6 sm:h-24" src="public/images/images/logos/Logo.png" alt=""/>
            </Link>
