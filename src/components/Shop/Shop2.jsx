...
<Link to="/singlepage/:id">
            ...
            <div className="max-w-sm rounded    transition-all overflow-hidden  shadow-md p-6 mb-6 ">
                ...
                <div className="px-6 py-4 flex flex-col gap-2">
                    <div className="font-bold text-xl mb-2 flex justify-between" >2020 Toyota Fortuner
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" id="svgheart" className="w-6 h-6" onClick={changeColor}>
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                        </svg>
                    </div>
                    ...
                    <div className='flex justify-between font-semibold'> <p className='font-semibold'>₹89,814/month </p> <p className='hover:text-green-600'> ₹40,02,000 </p></div>
                    <div> <p>Zero down payment</p></div>
                    <div className='flex'> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-4 h-4 mt-1">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
            ...
            <div className="max-w-sm rounded    transition-all overflow-hidden  shadow-md p-6 mb-6 ">
            ...
            </div> <div className="max-w-sm rounded    transition-all overflow-hidden  shadow-md p-6 mb-6 ">
                <img className="w-full" src='public/images/images/cars/toyota/44 (1).webp' alt="2016 Volkswagen Ameo" />
                <div className="px-6 py-4 flex flex-col gap-2">
                    <div className="font-bold text-xl mb-2 flex justify-between" >2015 Toyota Fortuner
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" id="svgheart" className="w-6 h-6" onClick={changeColor}>
             ...
             <div className="max-w-sm rounded    transition-all overflow-hidden  shadow-md p-6 mb-6 hover:bg-indigo-50">
                <img className="w-full" src='public/images/images/cars/toyota/44 (1).webp' alt="2016 Volkswagen Ameo" />
                <div className="px-6 py-4 flex flex-col gap-2">
                    <div className="font-bold text-xl mb-2 flex justify-between" >2020 Toyota Fortuner
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" id="svgheart" className="w-6 h-6" onClick={changeColor}>
            ...
            </div>  <div className="max-w-sm rounded    transition-all overflow-hidden  shadow-md p-6 mb-6 hover:bg-indigo-50">
                <img className="w-full" src='public/images/images/cars/toyota/44 (1).webp' alt="2016 Volkswagen Ameo" />
                <div className="px-6 py-4 flex flex-col gap-2">
                    <div className="font-bold text-xl mb-2 flex justify-between" >2020 Toyota Fortuner
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" id="svgheart" className="w-6 h-6" onClick={changeColor}>
