...
function Category() {
  return (
<>
  <div className='flex w-screen flex-row  gap-2 py-6 justify-center'>
    <div className="p-4 text-center w-40 hover:bg-blue-50 h-24 rounded hover:scale-105 hover:transition-all" >
  ...
  </div><div className="p-4 text-center hover:bg-blue-50 w-40 h-24 rounded  hover:scale-105 hover:transition-all" >
